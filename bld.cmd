...
if "%BUILD%"=="true" (
    ...
    javac -cp "libs\commons-compress-1.27.1.jar;libs\commons-io-2.16.1.jar;libs\commons-lang3-3.18.0.jar" %SRC1% %SRC2% %SRC3% src\main\core\org\kissweb\json\*.java -d work\exploded\WEB-INF\classes
)
